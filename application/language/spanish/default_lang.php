...
$lang['Hello %s, <p>To change your  email in cReader, click here %s  </p> Regards'] = 'Hola %s, <p> Para cambiar su correo electrónico en cReader, haga clic aquí %s </ p> Saludos';
$lang['We have sent you an email with instructions to change your email'] = 'Te hemos mandado un email con instrucciones para cambiar su dirección de correo electrónico';
