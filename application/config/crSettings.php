...
$config['entityConfig'] = array(
	...
	$config['entityTypeCountry'] => array(
		...
		'entityTypeSingleName' => 'country',
		'entityTypeIcon'       => 'fa-map-marker text-muted',
		'tableName'            => 'countries',
		'fieldId'              => 'countryId',
	...
	$config['entityTypeState'] => array(
		...
		'entityTypeSingleName' => 'state',
		'entityTypeIcon'       => 'fa-map-marker text-muted',
		'tableName'            => 'states',
		'fieldId'              => 'stateId',
		'fieldName'            => 'stateName',
		'fieldSef'             => 'stateSef',
		'customGetEntityName'  => true,
	),
	$config['entityTypeCity'] => array(
		'entityTypeName'       => 'cities',
		'entityTypeSingleName' => 'city',
		'entityTypeIcon'       => 'fa-map-marker text-muted',
		'tableName'            => 'cities',
		'fieldId'              => 'cityId',
		'fieldName'            => 'cityName',
