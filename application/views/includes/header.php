...
if (config_item('google-gtm-account') != '' && ENVIRONMENT == 'production') {
	echo ' <noscript><iframe src="//www.googletagmanager.com/ns.html?id='.config_item('google-gtm-account').'" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
